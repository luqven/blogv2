		...
		{#if isTruncated}
			<div class="flex justify-center">
				<button
					...
					class="inline-block rounded bg-blue-100 p-4 text-lg font-bold tracking-tight text-black hover:text-sky-900 dark:bg-blue-900 dark:text-white hover:dark:text-sky-200 md:text-2xl"
				>
					Load More Posts...
				</button>
			</div>
