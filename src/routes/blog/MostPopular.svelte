<section
	class="flex w-full flex-col gap-4 rounded-xl bg-slate-200 p-4 dark:bg-slate-700 dark:bg-opacity-50"
>
	...
	<a
		...
		><div class="w-full">
			...
			<p class="ml-8 text-gray-600  hover:text-sky-600 dark:text-gray-400 dark:hover:text-sky-100">
	...
	<a
		...
		><div class="w-full">
			<div class="flex flex-col justify-between md:flex-row">
				<h4 class="mb-2 w-full flex-auto text-lg font-bold md:text-xl">Moving to a GitHub CMS</h4>
			</div>
			<p class="ml-8 text-gray-600  hover:text-sky-600 dark:text-gray-400 dark:hover:text-sky-100">
